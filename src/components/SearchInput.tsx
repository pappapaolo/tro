...
export default function SearchInput() {
  ...
  // Keep latest params reachable inside the debounce timeout so it
  // never overwrites filters set after the user stopped typing.
  ...
  // If something else clears ?q (e.g. "Clear all" button), sync the input.
  ...
  return (
    <div className="relative w-full">
      <SearchIcon className="absolute left-3.5 top-1/2 -translate-y-1/2 text-(--color-muted) pointer-events-none" />
      <input
        type="search"
        value={q}
